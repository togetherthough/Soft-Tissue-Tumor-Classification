...
Intended to work with datasets exported by med3pipe.exports.export2d.export_swin_dataset
...
def _fit_classifier(
    ...
    for ep in range(1, epochs + 1):
        ...
        val_eval = _evaluate(model, dl_val, device, class_to_idx=dl_train.dataset.class_to_idx if hasattr(dl_train.dataset, 'class_to_idx') else {"0":0,"1":1})
