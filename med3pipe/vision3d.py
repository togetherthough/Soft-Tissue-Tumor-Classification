...
Labels come from the dataset CSV (e.g., gist/sheet.csv) via med3pipe.sam3d.load_labels_from_sheet.
...
from .sam3d import load_labels_from_sheet, make_pre_transform
